...
const Login = () => {
    ...
    const closeAlert = () => {
        // Setting the necessary state to null and false 
        setShowAlert(false); 
        setStatus(null); 
        setAlertMessage(null); 
    }

    // Creating a function for handling the login 
                ...
                <section className="w-full max-w-md bg-mil-gray border border-mil-border rounded-xl shadow-2xl p-8 space-y-8">
                    ...
                    <form className="space-y-6"> 
                        <div className="space-y-4">
                            {/* Email Address */}
                            <div> 
                                <label className="block text-xs font-semibold text-mil-blue-light uppercase mb-1"> 
                                    Email Address 
                                </label>
                                <input 
                                    type="email"
                    ...
                    <div className="text-center pt-4 border-t border-mil-border"> 
                        <p className="text-sm text-gray-400"> 
                            Haven't registered? {" "}
                            <a href="/register" className="text-mil-blue-light hover:underline font-semibold"> 
                                Register 
                            </a>
                        </p>
                    </div>
