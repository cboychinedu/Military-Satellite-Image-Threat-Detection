...
# Creating the route for the register page 
...
def registerPage(): 
    ...
    userData = registerUserDb.getUserDataForRegistration(email)
    ...
    # Else if the user is not present on the database, execute the block of code below 
    else: 
